        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">
              Welcome to Blogosocial—the future of blogging excellence starts here.
            </h2>
            <p className="text-xl text-white opacity-90 mb-8">
              Welcome to the vision of Blogosocial—a vision of authenticity, innovation, and limitless potential. Join
              us today as we redefine what it means to create truly exceptional blogs that inspire trust and drive
              meaningful growth.
            </p>
