        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">
              Ready to Simplify Your Academic Writing Process?
            </h2>
            <p className="text-xl text-white opacity-90 mb-8">
              Join our waitlist to be the first to know when our Academic Article Generator launches. Discover how our
              advanced tools can help you create polished research papers and essays effortlessly.
            </p>
            ...
            <p className="text-white mt-8 opacity-80">
              Blogosocial: Where Innovation Meets Expertise—Your Partner in Academic Content Excellence!
            </p>
          </motion.div>
        </div>
      </section>
