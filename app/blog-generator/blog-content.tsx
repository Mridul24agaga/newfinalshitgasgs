...
const BlogGenerator: React.FC<BlogGeneratorProps> = ({ onGenerate, loading }) => {
  ...
  return (
    <div className="flex min-h-screen bg-white">
      <AppSidebar />
      <div className="flex-1 bg-white overflow-auto" style={{ fontFamily: "'Inter', sans-serif" }}>
        {/* Font import */}
        <style jsx global>{`
        ...
        <div className="p-6 w-full">
          {!generationStarted ? (
            // Initial form view - improved layout
            <div className="max-w-xl mx-auto bg-white p-8 rounded-xl border border-gray-200 shadow-lg">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      ...
                      className={`py-4 px-4 rounded-lg flex items-center justify-center gap-2 transition-all ${
                      ...
                      disabled={loading}
                    >
                      <Sparkles className={`w-5 h-5 ${humanizeLevel === "normal" ? "text-white" : "text-[#294fd6]"}`} />
                    ...
                    <button
                      ...
                      disabled={loading}
                    >
                      <Zap className={`w-5 h-5 ${humanizeLevel === "hardcore" ? "text-white" : "text-[#294fd6]"}`} />
                      <span className="font-medium">Hardcore</span>
                    </button>
                  </div>
                  <p className="mt-2 text-sm text-gray-500">
                    {humanizeLevel === "normal"
                      ? "Normal humanization creates natural-sounding content"
                      : "Hardcore humanization creates highly unique and varied content"}
                  </p>
                </div>
            ...
            <div className="w-full mx-auto">
              ...
              <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-lg mb-8 max-w-[1200px] mx-auto">
                ...
                <div className="relative w-full h-[650px] border border-gray-200 rounded-xl overflow-hidden shadow-md">
              ...
              <div className="fixed bottom-6 right-6 bg-white rounded-xl border border-gray-200 p-6 shadow-xl max-w-sm w-full z-50">
