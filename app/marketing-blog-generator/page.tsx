        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-xl text-white opacity-90 mb-8">
              Join our waitlist to be the first to know when our Marketing Blog Generator launches. Discover how our
            ...
            <p className="text-white mt-8 opacity-80">
              Blogosocial: Where Innovation Meets Expertise—Your Partner in Marketing Content Excellence!
            </p>
          </motion.div>
        </div>
      </section>
