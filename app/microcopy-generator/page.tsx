      ...
      <section className="py-16 bg-[#FF9626]" id="contact">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">Ready to Enhance Your User Experience?</h2>
            <p className="text-xl text-white opacity-90 mb-8">
              Join our waitlist to be the first to know when our Microcopy Generator launches. Discover how our
              innovative tool can help you craft effective messaging effortlessly.
            </p>
            ...
            <p className="text-white mt-8 opacity-80">
              Blogosocial: Where Innovation Meets Expertise—Your Partner in UX Content Excellence!
            </p>
          </motion.div>
        </div>
      </section>
