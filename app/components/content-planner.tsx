              ...
              {days.map((day, index) => {
                ...
                return (
                  <div
                    ...
                    } ${isToday ? "border-l-2 border-l-orange-500" : ""}`}
                  >
                    ...
                    <div className="p-1 overflow-y-auto h-[85px]">
                      {postsForDay.map((post) => (
                        <div
                          ...
                          className="mb-1 px-1.5 py-1 text-xs border-l-2 border-l-orange-500 bg-orange-50 text-gray-900 cursor-pointer hover:bg-orange-100 transition-colors flex items-center"
                        >
