...
import { Code, ImageIcon, Video, LinkIcon, Sparkles } from 'lucide-react'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-8 md:p-12 flex flex-col justify-center">
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 text-sm">
                ...
                <pre className="text-[#294df6] overflow-x-auto font-sans">{content.codeSnippet}</pre>
              </div>
            ...
            <div className="relative">
              ...
              {activeTab === "videos" && (
                <div className="absolute top-8 right-8 bg-white text-gray-800 p-4 rounded-lg shadow-lg max-w-xs text-sm z-10 border border-gray-200">
                  <div className="text-[#294df6] mb-1">// Feature</div>
                  <p className="text-gray-600">
                    Automatically embeds relevant YouTube videos that complement your content, increasing engagement and
                    time on page.
                  </p>
                </div>
              )}
